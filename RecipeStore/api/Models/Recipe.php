...
*/
    ...
    public static function getRecipes($request)
    {
        ...
        */
        ...
        //build query
        $query = self::with('recipes');  //build the query to get all recipes
        ...
        $recipes = $query->get();  //Finally, run the query and get the results
    ...
    // The array includes links for the current, first, next, and last pages
